...
const allArithmeticOps = Object.keys(arithmeticAssignmentMethods)
const allBitwiseOps = Object.keys(bitwiseAssignmentMethods)
...
function assignmentEntry(context) {
  ...
  const isArithmeticAssignmentOp = makeOperatorGuard(allArithmeticOps)(context)
  const isBitwiseAssignmentOp = makeOperatorGuard(allBitwiseOps)(context)
