...
> 👋 **Note:** Since `v2.2.0` I hope you will be less inclined to use this setting because detection of concat operations on string-literals [is improved](https://github.com/shuckster/eslint-plugin-big-number-rules/blob/master/CHANGELOG.md#220---2023-04-12).
